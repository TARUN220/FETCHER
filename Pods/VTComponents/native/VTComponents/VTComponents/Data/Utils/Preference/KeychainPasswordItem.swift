...
struct KeychainPasswordItem {
    ...
    init(service: String, account: String, accessGroup: String? = nil, sharedAppList: [String]? = nil) {
        ...
        self.sharedAppTargets = sharedAppList
    }
    ...
    mutating func renameAccount(_ newAccountName: String) throws {
        ...
        let query = KeychainPasswordItem.keychainQuery(withService: service, account: self.account, accessGroup: accessGroup, sharedAppTargets: sharedAppTargets)
        let status = SecItemUpdate(query as CFDictionary, attributesToUpdate as CFDictionary)
